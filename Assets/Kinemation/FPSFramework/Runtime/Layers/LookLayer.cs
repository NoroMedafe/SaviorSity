        ...
        private void ApplySpineLayer()
        {
            ...
            foreach (var bone in lookRightOffset.bones)
            {
                ...
                CoreToolkitLib.RotateInBoneSpace(GetRootBone().rotation, bone.bone,
                    new Vector3(0f, lerpedAim.x * smoothLayerAlpha / (90f / angleFraction),0f));
            }
            ...
            foreach (var bone in lookRightOffset.bones)
            {
                ...
                CoreToolkitLib.RotateInBoneSpace(GetRootBone().rotation * Quaternion.Euler(0f, lerpedAim.x, 0f), bone.bone,
                    new Vector3(0f, 0f, leanInput * smoothLayerAlpha / (90f / angleFraction)));
            }
            ...
            foreach (var bone in lookUpOffset.bones)
            {
                ...
                CoreToolkitLib.RotateInBoneSpace(GetRootBone().rotation * Quaternion.Euler(0f, lerpedAim.x, 0f),
                    bone.bone,
                    new Vector3(lerpedAim.y * smoothLayerAlpha / (90f / angleFraction), 0f, 0f));
            }
